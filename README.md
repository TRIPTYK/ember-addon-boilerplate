...
OR
```zsh
pnpm add -D @triptyk/ember-addon-boilerplate
```
...
For the extended syntax, [see examples](/packages/ember-addon-boilerplate/tests/dummy/app/components/ui-show.hbs).
